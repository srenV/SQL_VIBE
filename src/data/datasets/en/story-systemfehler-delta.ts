...
export const storySystemfehlerDeltaDatasetEn: Dataset = {
  id: "story-systemfehler-delta",
  name: "SmartCity Server Logs (Delta)",
  description: "Story-exclusive log database for the case 'System Error Delta'.",
  tables: [
    {
      name: "events",
      columns: [
...
(1,1,'ERR_502','Gateway timeout at checkout processor','critical'),
(2,2,'ERR_502','Gateway timeout at checkout processor','critical'),
(3,3,'ERR_502','Gateway timeout at checkout processor','critical'),
(4,4,'ERR_404','Product not found','warning'),
(5,5,'ERR_404','Product not found','warning'),
(6,6,'ERR_404','Product not found','warning'),
(7,7,'ERR_500','Database connection interrupted','critical'),
(8,9,'ERR_500','Database connection interrupted','critical'),
(9,13,'ERR_500','Database connection interrupted','critical');
`,
};
