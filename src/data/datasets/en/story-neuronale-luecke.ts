...
export const storyNeuronaleLueckeDatasetEn: Dataset = {
  id: "story-neuronale-luecke",
  name: "ARGUS Streaming (Neural Gap)",
  description: "Story-exclusive streaming database for the case 'Neural Gap'.",
  tables: [
    {
      name: "users",
      columns: [
    ...
    },
    {
      ...
      columns: [
        ...
        { name: "reviewed_at", type: "DATETIME", nullable: false },
      ],
    },
  ],
...
(3,'The Matrix','Sci-Fi',1999,136,4.90),
(4,'Titanic','Drama',1997,194,4.50),
(5,'The Godfather','Drama',1972,175,4.60),
(6,'Schindler\'s List','Drama',1993,195,4.70),
(7,'Fight Club','Drama',1999,139,4.40),
(8,'Forrest Gump','Drama',1994,142,4.30),
(9,'Se7en','Crime',1995,127,4.20),
(10,'The Silence of the Lambs','Crime',1991,118,4.40),
...
(1,1,1,5,'Absolute masterpiece','2091-03-05 10:00:00'),
(2,4,1,5,'Unforgettable','2091-03-06 11:00:00'),
(3,7,1,5,'Top movie','2091-03-07 12:00:00'),
(4,2,4,4,'Moving','2091-03-08 13:00:00'),
(5,5,4,4,NULL,'2091-03-09 14:00:00'),
(6,8,4,4,'Timeless','2091-03-10 15:00:00'),
(7,3,7,3,'Confusing','2091-03-11 09:00:00'),
(8,6,7,4,'Intense','2091-03-12 10:00:00'),
(9,9,7,3,NULL,'2091-03-13 11:00:00'),
(10,4,3,5,'Cult classic!','2091-03-14 12:00:00'),
(11,1,3,5,'Classic','2091-03-15 13:00:00'),
(12,7,3,4,NULL,'2091-03-16 14:00:00'),
(13,2,2,4,'Captivating','2091-03-17 15:00:00'),
(14,5,2,4,NULL,'2091-03-18 16:00:00'),
(15,8,2,5,'Perfect','2091-03-19 17:00:00'),
(16,3,9,3,NULL,'2091-03-20 18:00:00'),
(17,6,9,4,'Thrilling','2091-03-21 19:00:00'),
(18,9,10,4,'Creepy','2091-03-22 20:00:00'),
(19,10,10,4,NULL,'2091-03-23 21:00:00'),
(20,2,5,5,'Masterpiece','2091-03-24 10:00:00'),
(21,4,5,4,NULL,'2091-03-25 11:00:00'),
(22,7,6,5,'Shattering','2091-03-26 12:00:00'),
(23,1,6,5,'Must-see','2091-03-27 13:00:00'),
(24,5,8,4,NULL,'2091-03-28 14:00:00'),
(25,8,8,3,'Good','2091-03-29 15:00:00'),
(26,3,11,3,NULL,'2091-03-30 16:00:00'),
(27,6,12,3,'Loud','2091-04-01 17:00:00'),
(28,9,13,4,NULL,'2091-04-02 18:00:00'),
(29,10,14,5,'Confusingly good','2091-04-03 19:00:00'),
