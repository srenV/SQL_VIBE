/**
 * Log analysis dataset (English).
 * Contains server logs with events, sessions, error codes, and performance metrics
 * for analysis-related SQL exercises.
 */
import type { Dataset } from "@/types/exercise";

export const logsDatasetEn: Dataset = {
  id: "logs",
  name: "Log Analysis",
  description:
    "Server logs with events, sessions, error codes, and performance metrics for analysis exercises.",
  tables: [
    {
      name: "events",
      columns: [
        ...
        { name: "page", type: "VARCHAR(100)", nullable: true },
    ...
    },
    {
      ...
      columns: [
        ...
        { name: "ip_address", type: "VARCHAR(15)", nullable: false },
    ...
    },
    {
      ...
      columns: [
        ...
        { name: "error_code", type: "VARCHAR(10)", nullable: false },
        { name: "message", type: "TEXT", nullable: false },
        { name: "severity", type: "VARCHAR(10)", nullable: false },
      ],
    },
  ],
...
(1,3,'ERR_404','Product page not found','warning'),
(2,9,'ERR_500','Database error loading products','critical'),
(3,11,'ERR_404','Product page not found','warning'),
(4,17,'ERR_502','Gateway timeout at checkout','critical'),
(5,22,'ERR_500','Payment gateway unreachable','critical'),
(6,26,'ERR_404','Product page not found','warning'),
(7,31,'ERR_502','Gateway timeout at checkout','critical'),
(8,36,'ERR_500','Database error at checkout','critical'),
(9,43,'ERR_502','Gateway timeout at checkout','critical');
`,
};