...
aggregationExercises.push(
  ...
  makeWriteExercise("agg", {
    title: "Durchschnittliche Wiederholungen",
    description: "Wie viele Wiederholungen werden im Durchschnitt pro Satz gemacht? Gib der Ergebnisspalte den Namen `durchschnitt`.",
    difficulty: "beginner",
    category: "Aggregation",
    datasetId: "fitness",
    referenceQuery: `SELECT AVG(wiederholungen) AS durchschnitt FROM saetze;`,
    expectedResultText: "",
    ...
    hints: [
      ...
      "Verwende `AVG` auf die Spalte `wiederholungen` in der Tabelle `saetze` mit dem Alias `durchschnitt`.",
    ],
    hiddenTestQuery: `SELECT AVG(wiederholungen) AS durchschnitt FROM saetze;`,
    hiddenTestMode: "rows",
  }),

  makeWriteExercise("agg", {
    title: "Hoechstes Abteilungsbudget",
    description: "Wie hoch ist das groesste Budget aller Abteilungen? Gib der Ergebnisspalte den Namen `maximum`.",
    difficulty: "beginner",
    category: "Aggregation",
    datasetId: "hr",
    referenceQuery: `SELECT MAX(budget) AS maximum FROM abteilungen;`,
    expectedResultText: "",
    ...
    hints: [
      ...
      "Verwende `MAX` auf die Spalte `budget` in der Tabelle `abteilungen` mit dem Alias `maximum`.",
    ],
    hiddenTestQuery: `SELECT MAX(budget) AS maximum FROM abteilungen;`,
    hiddenTestMode: "rows",
  }),
  ...
  makeWriteExercise("agg", {
    title: "Gesamtlagerbestand",
    description: "Wie viele Produkte befinden sich insgesamt im Lager? Gib der Ergebnisspalte den Namen `gesamt`.",
    difficulty: "beginner",
    category: "Aggregation",
    datasetId: "shop",
    referenceQuery: `SELECT SUM(lagerbestand) AS gesamt FROM produkte;`,
    expectedResultText: "",
    tags: ["Aggregation", "SUM"],
    hints: [
      "Du moechtest alle Zahlenwerte einer Spalte aufaddieren — eine Aggregatfunktion erledigt das fuer dich.",
      "`SUM(spalte)` berechnet die Summe aller Werte: `SELECT SUM(spaltenname) AS alias FROM tabelle`",
      "Verwende `SUM` auf die Spalte `lagerbestand` in der Tabelle `produkte` mit dem Alias `gesamt`.",
    ],
    hiddenTestQuery: `SELECT SUM(lagerbestand) AS gesamt FROM produkte;`,
    hiddenTestMode: "rows",
  }),
  ...
  makeWriteExercise("agg", {
    title: "Kleinster Bestellwert",
    description: "Wie hoch ist der niedrigste Gesamtbetrag aller Bestellungen? Gib der Ergebnisspalte den Namen `minimum`.",
    difficulty: "beginner",
    category: "Aggregation",
    datasetId: "shop",
    referenceQuery: `SELECT MIN(gesamtbetrag) AS minimum FROM bestellungen;`,
    expectedResultText: "",
    tags: ["Aggregation", "MIN"],
    hints: [
      "Du moechtest den kleinsten Wert in einer Spalte finden — eine Aggregatfunktion liefert dir genau das.",
      "`MIN(spalte)` gibt den niedrigsten Wert zurueck: `SELECT MIN(spaltenname) AS alias FROM tabelle`",
      "Verwende `MIN` auf die Spalte `gesamtbetrag` in der Tabelle `bestellungen` mit dem Alias `minimum`.",
    ],
    hiddenTestQuery: `SELECT MIN(gesamtbetrag) AS minimum FROM bestellungen;`,
    hiddenTestMode: "rows",
  })
);
