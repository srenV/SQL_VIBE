  ...
  return (
    <footer className="border-t border-surface-dim dark:border-dark-dim py-6 text-center text-sm text-ink-muted">
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
        ...
        <Link href="/lektionen" className="hover:text-ink transition-colors">
          Üben
        </Link>
        <Link href="/sandbox" className="hover:text-ink transition-colors">
          Sandbox
        </Link>
        <Link href="/lernen" className="hover:text-ink transition-colors">
          Lernen
        </Link>
        <span className="text-surface-dim dark:text-dark-dim">|</span>
